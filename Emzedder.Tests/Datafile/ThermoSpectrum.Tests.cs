...
public class ThermoSpectrumTests : BaseTest
{
    ...
    public void Constructor_TakesSegmentedScan_GivesCorrectProfileData()
    {
        ...
        //Act
        ThermoSpectrum thermoSpectrum = new(segmentedScan);
    ...
    public void Constructor_TakesCentroidStream_GivesCorrectCentroidData()
    {
        ...
        ThermoFisher.CommonCore.Data.Interfaces.IRawDataExtended rawData = RawFileReaderAdapter.FileFactory(_validFilePath);
        rawData.SelectInstrument(Device.MS, 1);
        ScanStatistics scanStatistics = rawData.GetScanStatsForScanNumber(_centroidScanNumber);
        CentroidStream centroidStream = rawData.GetCentroidStream(_centroidScanNumber, false);
    ...
    public void Constructor_TakesSegmentedScan_CalculatedCorrectCentroidData()
    {
        ...
        //Assert
        foreach (MSDatapoint datapoint in expectedCentroids)
        {
